function display_donation_campaigns_shortcode($atts) {
    ...
    $user_id = get_current_user_id(); // Assuming this is defined somewhere
    ...
    echo '<style>
        .donation-campaigns-grid {
            ...
            grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); /* Creates columns that are at least 300px wide */
            overflow-x: auto; /* Allows overflow if there are more than 6 campaigns */
        }
        ...
        .donation-campaign-box {
            ...
            max-width: 500px; /* Maximum width for the campaign box */
            width: 100%; /* Ensure the box takes up full width within its max-width constraint */
            margin: auto; /* Center align in its grid cell */
        }
